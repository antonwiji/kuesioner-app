...
if (isset($_SESSION['admin_login'])) {
  header("Location: testingsurvie.php");
  exit();
}
...
if (isset($_POST['btn-signin'])) {
  ...
  $query = "SELECT user_name, password from auth_db WHERE user_name = '$user_name'";
...
<body class="text-center">
  ...
  <main class="form-signin w-100 m-auto">
    <form method="post">
      <img src="./src/img/logo_login.jpeg" class="img-fluid" alt="logo-login">
      ...
      <button class="w-100 btn btn-lg btn-primary" type="submit" name="btn-signin">Sign in</button>
